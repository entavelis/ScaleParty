...
def parse_args():
    ...
    parser.add_argument('--use_noise', dest='use_noise', action='store_true')
    parser.add_argument('--no_noise', dest='use_noise', action='store_false')
...
def noise_regularize(noises):
    ...
    for noise in noises:
        ...
        while True:
            ...
            # NOTE my change to check if odd
            if size <= 8 or size % 2:
                break
...
def main():
    ...
    for i in pbar:
        ...
        img_gen = generator([latent_n],
                            ...
                            injected_noise=noises if args.use_noise else None)
        ...
        pbar.set_description(
            ...
            f'{n_loss.item() if args.use_noise else 0:.4f}, mse: {mse_loss.item():.4f}, lr: {lr:.4f}')
