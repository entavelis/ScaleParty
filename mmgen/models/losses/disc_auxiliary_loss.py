...
def r1_gradient_penalty_loss(discriminator,
    ...
    if real_data_x2 is not None:
        batch_size *= 2
        real_data_x2 = real_data_x2.clone().requires_grad_()


    disc_pred = discriminator(real_data, real_data_x2)
    if loss_scaler:
    ...
    gradients = autograd.grad(
        outputs=disc_pred,
        inputs=real_data if real_data_x2 is None else (real_data, real_data_x2),
